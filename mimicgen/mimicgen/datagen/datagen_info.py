...
class DatagenInfo(object):
    ...
    def __init__(
        ...
        target_pose=None,
        gripper_action=None,
        expert_frame_segments=None,
        grasp_object_poses=None,
    ):
        """
        Args:
        ...
        self.grasp_object_poses = None
        if grasp_object_poses is not None:
            self.grasp_object_poses = { k : np.array(grasp_object_poses[k]) for k in grasp_object_poses }
        if expert_frame_segments is not None:
            self.expert_frame_segments = expert_frame_segments
