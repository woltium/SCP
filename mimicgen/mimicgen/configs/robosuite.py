...
class Coffee_Config(MG_Config):
    ...
    def task_config(self):
        ...
        self.task.task_spec.subtask_2 = dict(
            ...
            selection_strategy="nearest_grasp_object_rel_target_object",
            selection_strategy_kwargs=dict(nn_k=3,grasp_object_ref="coffee_pod"),
            action_noise=0.05,
            num_interpolation_steps=5,
            num_fixed_steps=0,
            apply_noise_during_interpolation=False,
            grasp_object_ref="coffee_pod",
        )
...
class Threading_Config(MG_Config):
    ...
    def task_config(self):
        ...
        self.task.task_spec.subtask_2 = dict(
            ...
            subtask_term_offset_range=None,
            selection_strategy="nearest_grasp_object_rel_target_object",
            selection_strategy_kwargs=dict(nn_k=3,grasp_object_ref="needle"),
            action_noise=0.05,
            num_interpolation_steps=5,
            num_fixed_steps=0,
            apply_noise_during_interpolation=False,
            grasp_object_ref="needle",
        )
        self.task.task_spec.do_not_lock_keys()
...
class ThreePieceAssembly_Config(MG_Config):
    ...
    def task_config(self):
        ...
        self.task.task_spec.subtask_2 = dict(
            ...
            subtask_term_offset_range=(5, 10),
            selection_strategy="nearest_grasp_object_rel_target_object",
            selection_strategy_kwargs=dict(nn_k=3,grasp_object_ref="piece_1"),
            action_noise=0.05,
            num_interpolation_steps=5,
            num_fixed_steps=0,
            apply_noise_during_interpolation=False,
            grasp_object_ref="piece_1",
        )
        ...
        self.task.task_spec.subtask_4 = dict(
            ...
            subtask_term_offset_range=None,
            selection_strategy="nearest_grasp_object_rel_target_object",
            selection_strategy_kwargs=dict(nn_k=3,grasp_object_ref="piece_2"),
            action_noise=0.05,
            num_interpolation_steps=5,
            num_fixed_steps=0,
            apply_noise_during_interpolation=False,
            grasp_object_ref="piece_2",
        )
        self.task.task_spec.do_not_lock_keys()
...
class Square_Config(MG_Config):
    ...
    def task_config(self):
        ...
        self.task.task_spec.subtask_2 = dict(
            ...
            subtask_term_offset_range=None,
            selection_strategy="nearest_grasp_object_rel_target_object",
            selection_strategy_kwargs=dict(nn_k=3,grasp_object_ref="square_nut"),
            action_noise=0.05,
            num_interpolation_steps=5,
            num_fixed_steps=0,
            apply_noise_during_interpolation=False,
            grasp_object_ref="square_nut",
        )
        self.task.task_spec.do_not_lock_keys()
...
class HammerCleanup_Config(MG_Config):
    ...
    def task_config(self):
        ...
        self.task.task_spec.subtask_3 = dict(
            ...
            subtask_term_offset_range=None,
           selection_strategy="nearest_grasp_object_rel_target_object",
            selection_strategy_kwargs=dict(nn_k=3,grasp_object_ref="hammer"),
            action_noise=0.05,
            num_interpolation_steps=5,
            num_fixed_steps=0,
            apply_noise_during_interpolation=False,
            grasp_object_ref="hammer",
        )
        self.task.task_spec.do_not_lock_keys()
...
class MugCleanup_Config(MG_Config):
    ...
    def task_config(self):
        ...
        self.task.task_spec.subtask_3 = dict(
            ...
            subtask_term_offset_range=None,
           selection_strategy="nearest_grasp_object_rel_target_object",
            selection_strategy_kwargs=dict(nn_k=3,grasp_object_ref="object"),
            action_noise=0.05,
            num_interpolation_steps=5,
            num_fixed_steps=0,
            apply_noise_during_interpolation=False,
            grasp_object_ref="object",
        )
        self.task.task_spec.do_not_lock_keys()
...
class CoffeePreparation_Config(MG_Config):
    ...
    def task_config(self):
        ...
        self.task.task_spec.subtask_2 = dict(
            ...
            subtask_term_offset_range=(5, 10),
            selection_strategy="nearest_grasp_object_rel_target_object",
            selection_strategy_kwargs=dict(nn_k=3,grasp_object_ref="mug"),
            action_noise=0.05,
            num_interpolation_steps=5,
            num_fixed_steps=0,
            apply_noise_during_interpolation=False,
            grasp_object_ref="mug",
        )
        self.task.task_spec.subtask_3 = dict(
            object_ref="drawer", 
